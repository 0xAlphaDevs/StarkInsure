...
#[starknet::interface]
pub trait IHealthAnalyticsNFT<TContractState> {
...
mod HealthAnalyticsNFT {
    ...
    use super::{ContractAddress, IHealthAnalyticsNFT};
    ...
    #[abi(embed_v0)]
    impl HealthAnalyticsNFTImpl of IHealthAnalyticsNFT<ContractState> {
